// Page statistiques — lecture seule de stats_daily, calcul des moyennes.
// Entrée de bundle indépendante (comme main.js), bundlée en stats-bundle.js.
...
async function loadStats() {
  try {
    ...
    snapshot.forEach(doc => {
      const data = doc.data();
      total += data.count || 0;
      const dayDate = new Date(doc.id + 'T00:00:00');
    ...
    // +1 pour compter le premier jour lui-même (inclusif)
