(() => {
  ...
  var ALL_WORDS = [
    ...
    "DOR\xC9",
    "ARGENT\xC9",
    // --- Equilibrage des longueurs (juillet 2026) ---
    // Equilibrage 4 lettres (juillet 2026, parite avec 5 lettres)
    "CLEF",
    "VASE",
    "CAGE",
    "DRAP",
    ...
    "ID\xC9E",
    "R\xCAVE",
    // Equilibrage 7 lettres (parite avec 6/8 lettres)
    "DESSERT",
    "CUISINE",
    "AMPOULE",
    "BANDEAU",
    ...
    "ACCUEIL",
    "BASCULE",
    // Equilibrage 8 lettres (parite avec 6/7 lettres)
    "FROMAGER",
    "VENDEUSE",
    "SERVEUSE",
    "PEINTURE",
    ...
    "\xC9MERAUDE",
    "LAITERIE",
    // Renfort 10 lettres (difficile, meilleur equilibre)
    "TOURTEREAU",
    "ABRICOTIER",
    "CITRONNIER",
    "BIOLOGISTE",
    ...
    "REPR\xC9SENTATION",
    "RECONSTITUTION",
    "T\xC9L\xC9SPECTATEUR",
    "CIN\xC9MATOGRAPHE",
    "ERGOTH\xC9RAPEUTE",
    "KIN\xC9SITH\xC9RAPIE",
    "NUTRITIONNISTE",
    "\xC9LECTROM\xC9NAGER",
    "IMPERM\xC9ABILIT\xC9",
    "M\xC9CONNAISSANCE",
    "SP\xC9CIALISATION",
    "G\xC9N\xC9RALISATION",
    "INDIVIDUALISME",
    "ENDOCRINOLOGIE",
    "RECONSTRUCTION",
    "INFRASTRUCTURE",
